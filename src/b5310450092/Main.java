        ...
        while(true)
        {
            ...
            switch (cho)
            {
                case 1:	System.out.println("+++Input Product+++");
                        ...
                        count = sc.nextInt();		
                        shop[i] = new Inventory(name, count,id); // 40 point
                        i++;
                        id++;
                        System.out.println("+++++++++++++++++++");
                        break;
                ...
                case 3: System.out.println("+++Edit Count+++");
                        ...
                        for(int j=0;j<i;j++)
                        {
                            if(shop[j].outName().equals(name))
                            {
                                ...
                                shop[j].addCount(sc.nextInt()); // 40 point
                                break;
                            }
                        }
                        System.out.println("++++++++++++++++");
                ...
                case 4: System.out.println("+++Print Inventory+++");
                        ...
                        for(int j=0;j<i;j++)
                        {
                            System.out.println("Product id:"+shop[j].id+" Product name:"+shop[j].outName()+" Outstanding :"+shop[j].showCount()); // 20 point
                        }
                        System.out.println("+++++++++++++++++++++");
                        break;
