...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.print("Edit Name Product (y/n) : "); //ต้องการแก้ไขสินค้าอีกไหม ?
		String c ;
		c = sc.next();
		if(c.equals("y")){
		...
		System.out.print("Add Number Product :"); // เพิ่ม จำนวนสินค้า
		int add;
		add = sc.nextInt();
		bell[i].addProdouct(add);
		
		System.out.print("Add Product (y/n) :"); //ต้องการเพิ่มจำรวนสินค้าอีกไหม ?
		String d;
		d = sc.next();
		if(d.equals("y")){
